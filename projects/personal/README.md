...
Self-directed builds pursued alongside the Web Developer Academy roadmap, not as a
...
Each project folder should have its own README with, at minimum:

- Problem statement / goal
- Current status
- What roadmap skills it connects to
- Next steps

## Projects

- [youtube-automation](youtube-automation/README.md) — faceless, automated YouTube channel
  documenting my Web Developer learning, to teach others the same path.
